...
const SearchBar = ({showModal, setQuery, query, setTimeToCook, timeToCook, search}) => {
    ...
    return (
        <div className={"mb-4"}>
            <Row className={"mt-5"}>
                <div className={"mx-auto col-xl-5 col-lg-6 col-sm-8 col-10"}>
                    <div className={"search-bar-container d-flex justify-content-center align-items-center rounded-5 p-2 shadow-sm"}>
                        ...
                        <div className={"p-2 search-icon cursor-pointer"} onChange={search}>
                            <BsSearch className={"font-1-8rem color-dsg"}/>
                        </div>
                    </div>
                </div>
                <div className={"col-12 d-flex justify-content-center align-items-center pt-2 pb-sm-2 pb-3 color-lsg color-dsg-hover cursor-pointer"}
            ...
            <Row className={`${showMenu ? "d-flex" : "d-none"} w-60 mb-5 mx-auto justify-content-center align-items-center responsive-width`}>
                ...
                <div className={"col-2 d-flex justify-content-center align-items-center pt-sm-0 pt-2"}>
                    <Button variant="success" className={"d-flex align-items-center font-1rem rounded-4 px-3"} onClick={showModal}>
